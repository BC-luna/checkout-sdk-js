...
describe('PaypalCommerceRequestSender', () => {
    ...
    describe('setupPayment', () => {
        ...
        it('set shipping options', async () => {
           ...
           expect(requestSender.put).toHaveBeenCalledWith('/api/storefront/initialization/paypalcommerce', {body:{ payload: {...setShippingDataMock}}, headers})
        });
